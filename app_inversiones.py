            ...
            try:
                ...
                if analisis['color'] == 'verde':
                    ...
                    conclusion = (
                        ...
                        "Se recomienda no agregar posiciones hasta que el precio estabilice sobre su MA50 "
                        f"${analisis['ma50']:,.2f}."
                    )
                else:
                    conclusion = (
                        ...
                        "El catalizador para una entrada de menor riesgo sería un cierre por encima de la MA50 " f"${analisis['ma50']:,.2f} "
